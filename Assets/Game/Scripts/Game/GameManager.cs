...
namespace Game
{
    public class GameManager : IDisposable
    {
        ...
        public GameManager(PlayerPresenter player, EnemySpawnerPresenter spawnerPresenter, ProgressionPresenter progressionPresenter, UpgradePresenter upgradePresenter, Wallet wallet, IInput input, IUIService ui)
        {
            _player = player;
