...
namespace Game
{
    public class UpgradeWindowPresenter : ScreenPresenter
    {
        ...
        private readonly UpgradeButtonView.Pool _buttonPool;
        ...
        public UpgradeWindowPresenter(
            ...
            UpgradeButtonView.Pool buttonPool
        )
        {
            _view = view;
        ...
        private void SetInfo(UpgradeButtonViewData data)
        {
            ...
            {
                UpgradeButtonView button = _buttonPool.Spawn();
                button.transform.SetParent(_view.ButtonsContainer, false);
                _upgradeButtonsDictionary[data.Name] = button;
