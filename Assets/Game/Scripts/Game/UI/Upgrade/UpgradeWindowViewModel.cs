...
namespace Game
{
    public class UpgradeWindowViewModel : IDisposable
    {
        ...
        private readonly ObservableDictionary<Weapons, UpgradeButtonViewModel> _upgradeButtonsDictionary = new();
        ...
        public ReadOnlyReactiveProperty<int> Crystals => _wallet.Crystals;
        public IReadOnlyObservableDictionary<Weapons, UpgradeButtonViewModel> Buttons => _upgradeButtonsDictionary;
        ...
        {
            _disposable.Dispose();
            foreach (KeyValuePair<Weapons, UpgradeButtonViewModel> button in _upgradeButtonsDictionary) button.Value.Dispose();
        }
