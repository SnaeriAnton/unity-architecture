...
namespace Game
{
    public class ProgressionModel : IProgressionReadModel
    {
        ...
        private readonly ReactiveProperty<int> _maxUpgrade = new();
        ...
        public ReadOnlyReactiveProperty<int> MaxUpgrade => _maxUpgrade;
        public Observable<Unit> OnLevelUp => _onLevelUp;
        public Observable<Unit> OnLevelUpSpawner => _onLevelUpSpawner;
