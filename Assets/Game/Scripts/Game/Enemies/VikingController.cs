...
namespace Game
{
    public class VikingController : EnemyController
    {
        ...
        public VikingController(EnemyViewModel viewModel, EnemyView view, EnemyModel model, Axe axeTemplate, IEnemyDeathProcessor enemyDeathProcessor, IProjectileFactory factory, ITarget target, IGameLoop gameLoop) : base(viewModel, view, model, enemyDeathProcessor, target)
        {
            _factory = factory;
