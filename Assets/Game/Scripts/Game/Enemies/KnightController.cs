...
namespace Game
{
    public class KnightController : EnemyController
    {
        ...
        public KnightController(EnemyViewModel viewModel, EnemyView view, EnemyModel model, IEnemyDeathProcessor enemyDeathProcessor, ITarget target)
            : base(viewModel, view, model, enemyDeathProcessor, target)
        {
