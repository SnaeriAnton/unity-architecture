...
namespace Game
{
    public class EnemySpawnerPresenter : ITickable, IEnemyStageProgression
    {
        ...
        public EnemySpawnerPresenter(GeneratorData data, IEnemyFactory factory, ISpawnPointProvider border, ITarget player, IRuntimeTickRegistry runtimeTickRegistry)
        {
            _data = data;
            _factory = factory;
            _border = border;
        ...
        public void Tick()
        {
            ...
            _runtimeTickRegistry.Add(enemy);
        }
