...
namespace Game
{
    public class Swords : Weapon
    {
        ...
        private int _orbitWeaponEntity;
        ...
        public override void SetStats(WeaponStats stats)
        {
            ...
            {
                _orbitWeaponEntity = OrbitWeaponApi.RegisterOrbitWeapon(transform, degreesPerSecond);
                _isOrbitRegistered = true;
            }
            else
            {
                OrbitWeaponApi.RequestSetOrbitWeaponRotation(_orbitWeaponEntity, degreesPerSecond);
            }
            ...
            foreach (Sword sword in _swords)
                sword.Init(WeaponHitboxApi, _stats.Damage);
        }
        ...
        private void AddSwords()
        {
            ...
            _swords.ForEach(s => s.Init(WeaponHitboxApi, _stats.Damage));
        }
