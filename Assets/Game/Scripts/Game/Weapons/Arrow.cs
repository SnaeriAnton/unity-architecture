...
namespace Game
{
    public class Arrow : MonoBehaviour, IPoolable, IRuntimeTickable
    {
        private Action _onDespawned;
        private WeaponStats _stats;
        private Vector3 _direction;
        private IRuntimeTickRegistry _loop;
        private float _liveTime;

        public int PoolID { get; private set; }

        public void Init(IRuntimeTickRegistry loop, WeaponStats stats, Vector3 direction)
        {
            _loop = loop;
            _stats = stats;
