...
namespace Game
{
    ...
    {
        private readonly BoolReactiveProperty _hasShield = new();
        private readonly IntReactiveProperty _currentCoolDownCount = new();
        private readonly IntReactiveProperty _coolDown = new();
        
        private WeaponStats _stats;
        
        public IReadOnlyReactiveProperty<bool> HasShield => _hasShield;
        public IReadOnlyReactiveProperty<int> CurrentCoolDownCount => _currentCoolDownCount;
        public IReadOnlyReactiveProperty<int> CoolDown => _coolDown;
